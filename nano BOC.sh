...
echo -e "${BLUE}===== BOC LITE PRO (NO ROOT) =====${NC}"
echo "[1] 🎮 Gaming Mode Boost"
echo "[2] 🔄 Restore Normal Mode"
echo "[3] 🧹 Clean Cache (Safe)"
echo "[4] 📊 Device Info"
echo "[5] ❌ Exit"
echo "================================="
...
# تقليل أنيميشن (أقوى حاجة فعالة بدون روت)
...
# محاولة إغلاق الخلفية (قد لا تعمل على كل الأجهزة)
cmd activity kill-all 2>/dev/null

echo -e "${GREEN}✅ Gaming Mode ON (Optimized UI + RAM freed)${NC}"
sleep 2
;;
